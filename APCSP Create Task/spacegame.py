...
def gameLoop():
        ...
        class playerSpaceShip():
            ...
            def spaceshipLeft(self):
                self.playerSpaceShipx -= self.playerSpaceShipSpeed
            def spaceshipRight(self):
                self.playerSpaceShipx += self.playerSpaceShipSpeed
            def spaceshipUp(self):
                self.playerSpaceShipy -= self.playerSpaceShipSpeed
        ...
        while gameRunning == True:
            ...
            if keyPressed[pygame.K_LEFT] == True and spaceship.playerSpaceShipx >= 0:
                spaceship.spaceshipLeft()
            if keyPressed[pygame.K_RIGHT] == True and spaceship.playerSpaceShipx <= gameWindowWidth - spaceship.playerSpaceShipWidth:
                spaceship.spaceshipRight()
            if keyPressed[pygame.K_UP] == True and spaceship.playerSpaceShipy >= 0:
                spaceship.spaceshipUp()
            if keyPressed[pygame.K_DOWN] == True and spaceship.playerSpaceShipy <= gameWindowHeight - spaceship.playerSpaceShipHeight:
