...
def introLoop():
    ...
    while gameRunning == True:
        ...
        def drawGameWindow():
            ...
            gameWindow.blit(rule1DisplayText, (30, 50))
            gameWindow.blit(rule2DisplayText, (22, 85))
            gameWindow.blit(rule3DisplayText, (37, 120))
            gameWindow.blit(playedDisplayText, (9, 155))
            gameWindow.blit(pressQDisplayText, (121, 190))
            pygame.display.update()

        # Arrow keys to move. Space to shoot.
        red = (255, 0, 0)
        rule1Text = textClass("Arrow keys to move. Space to shoot.", red, 25)
        rule1DisplayText = rule1Text.textDisplay()

        # Orange fireballs increase your score.
        orange = (255, 162, 0)
        rule2Text = textClass("Orange fireballs increase your score.", orange, 25)
        rule2DisplayText = rule2Text.textDisplay()

        # Blue fireballs decrease your score.
        blue = (0, 81, 255)
        rule3Text = textClass("Blue fireballs decrease your score.", blue, 25)
        ...
        # Press Q to continue.
        pressQText = textClass("Press Q to continue.", red, 25)
